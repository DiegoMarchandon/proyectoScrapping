...
final class ChromeManager implements BrowserManagerInterface
{
    ...
    {
        if ($binary = (new ExecutableFinder())->find('msedgedriver', null, ['./drivers', './vendor/bin'])) {
            return $binary;
        }

        throw new \RuntimeException('"msedgedriver" binary not found. Install it using the package manager of your operating system or by running "composer require --dev dbrekelmans/bdi && vendor/bin/bdi detect drivers".');
    }
